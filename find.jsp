...
if(emailChecked == false) {
	...
	script.println("alert('이메일인증을 받으세요.')");
	script.println("</script>");
	script.close();		
	return;
}
...
<script type="text/javascript">
	...
	function getFriend(findID){
		$('#friendResult').html('<thead>' + 
				...
				'<tbody>' +
				'<tr>' +
				'<td style="text-align: center;"><h3>' + findID + '</h3><a href="chat.jsp?toID=' + encodeURIComponent(findID) + '" class="btn btn-black pull-right">' + '메시지 보내기</a></td>' +
				'</tr>' +
				'</tbody>');
	}
	function failFriend(){
...
<a class="navbar-brand" href="index.jsp">Far From Home</a>
</div>
...
<div class="container">
	<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
		...
		<tbody>
			...
			<tr>
				<td colspan="2"><button class="btn btn-black pull-right" onclick="findFunction();">검색</button></td>
			</tr>
		</tbody>
	</table>
</div>
