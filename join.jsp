...
//ajax비동기 통신
	$.ajax({
		...
		success: function(result){
			...
			$('#checkModal').modal("show"); //부트스트랩 모달이 우리눈에 보일 수 있도록
		}
		});
}
...
<form method="post" action="./userRegister">
	...
	<tr>
		...
		<td style="width: 110px;"><button class ="btn  btn-dark" onclick="registerCheckFunction();" type="button">중복체크</button></td>
	</tr>
	<tr>
	...
	<tr>
		<td style="text-align: left;" colspan="3"><h5 style="color: black;" id="passwordCheckMessage"></h5><input class="btn btn-dark pull-right" type="submit" value="등록"></td>
	</tr>
	</tbody>
	</table>
</form>
