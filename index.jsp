  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="images/1.jpg" class="d-block w-100" alt="on my way" height="600px;">
      ...
      <div class="carousel-item">
        <img src="images/2.jpg" class="d-block w-100" alt="street"  height="600px;" >
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="images/3.jpg" class="d-block w-100" alt="awsome"  height="600px;">
        <div class="carousel-caption d-none d-md-block">
